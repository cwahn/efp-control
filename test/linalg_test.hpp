...
TEST_CASE("mat_map") {
    const Matrix2d am {{-2., -1.}, {1., 0.}};

    const Matrix2d refm {{4., 1.}, {1., 0.}};

    const auto square_ = [](auto x) { return square<double>(x); };

    CHECK(is_mat_approx(mat_map(square_, am), refm));
}

TEST_CASE("solve") {
    const Matrix3d a {{1., 2., 3.}, {4., 5., 6.}, {7., 8., 10.}};
...
TEST_CASE("eigenvalues") {
    const Matrix3d a {{2, 1, 0}, {1, 3, 1}, {0, 1, 2}};
    const Vector3<std::complex<double>> ref {
...
TEST_CASE("poly_from_roots") {
    ...
    SECTION("complex") {
        const Vector2<Complex<double>> roots {Complex<double> {1., 1.}, Complex<double> {1., -1.}};
...
TEST_CASE("characteristic_poly") {
    SECTION("real") {
        const Matrix2d a {{0., 1. / 3.}, {-1. / 2., 0}};

        const Vector3d ref {1., 0., 0.1666666666666666667};
...
TEST_CASE("tf_from_ss") {
    SECTION("static") {
        ...
        const Matrix2d bm {{1., 1.}, {0., 0.}};

        const Matrix2d cm {{1., 2.}, {1., 2.}};

        const Matrix2d dm {{1., 0.}, {0., 1.}};
    ...
    SECTION("dynamic") {
        const MatrixXd am {{-2., -1.}, {1., 0.}};

        const MatrixXd bm {{1., 1.}, {0., 0.}};

        const MatrixXd cm {{1., 2.}, {1., 2.}};

        const MatrixXd dm {{1., 0.}, {0., 1.}};
